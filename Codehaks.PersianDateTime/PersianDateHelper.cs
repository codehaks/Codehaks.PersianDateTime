...
namespace Codehaks.PersianDateTime
{
    ...
    {
        public readonly PersianCalendar PersianCalendar;
        ...
        private void SetDate(DateTime today)
        {
            Year = PersianCalendar.GetYear(today);
            Month = PersianCalendar.GetMonth(today);
            Day = PersianCalendar.GetDayOfMonth(today);
        }
        ...
        public PersianDateTime(short year, byte month, byte day)
        {
            PersianCalendar = new PersianCalendar();
        ...
        public DateTime ToGeorgian()
        {
            var geDate = new DateTime(Year, Month, Day, PersianCalendar);
            return geDate;
        }
        ...
        {
            return String.Concat(Year % 100, "/" + Month + "/" + Day);
        }
